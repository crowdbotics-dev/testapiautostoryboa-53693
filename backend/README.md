...
## Project Structure
    ...
    ├── testapiautostoryboa_53693  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_53693`
...
2. Clone this repo and `cd testapiautostoryboa_53693`
